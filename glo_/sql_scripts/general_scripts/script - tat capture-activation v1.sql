--> tat_postpaid new reg (capture to activation)
select date(registration_timestamp),  
case 
	when mttc2 between 0 and 5 then '0-5mins'
	when mttc2 between 6 and 10 then '6-10mins'
	when mttc2 between 11 and 30 then '11-30mins'
	when mttc2 between 31 and 60 then '31mins-1hr'
	when mttc2 between 61 and 1439 then 'greater_than_1hr'
	when mttc2 > 1439 then 'greater_than_24 hrs'
	when mttc2 is null then 'N/A'
...
--> tat_prepaid new reg (capture to activation)
select date(registration_timestamp),  
case 
	when mttc2 between 0 and 5 then '0-5mins'
	when mttc2 between 6 and 10 then '6-10mins'
...
--> tat_postpaid re reg (capture to activation)
select date(registration_timestamp),  
case 
	when mttc2 between 0 and 5 then '0-5mins'
	when mttc2 between 6 and 10 then '6-10mins'
...
--> tat_prepaid re reg (capture to activation)
select date(registration_timestamp),  
case 
	when mttc2 between 0 and 5 then '0-5mins'
	when mttc2 between 6 and 10 then '6-10mins'
