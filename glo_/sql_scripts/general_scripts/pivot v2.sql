------latest_scripts_tat PIVOT new reg alone without the addition 
-----of re-registration to match with auto generated report RECEIVED ON THE  23rd -JUNE -2021
...
and date(bsl.create_date) = '2021-07-26'
) 
...
select * from bfp_sync_log bsl where date(create_date) = '2021-06-23' and reg_type like 'NM%' and bfpsyncstatusenum = 'SUCCESS'