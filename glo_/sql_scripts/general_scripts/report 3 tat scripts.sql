...
S.receipt_timestamp  as time_released_from_eyeball,
	round((extract(epoch from s.receipt_timestamp)::numeric - extract(epoch from bb.create_date)::numeric)/ 60, 2) as TIME_TAKEN
from
	meta_data m
