...
select
	...
	m.sync_timestamp as time_uploaded_to_sfx,
	round((extract(epoch from m.sync_timestamp)::numeric - extract(epoch from s.registration_timestamp)::numeric)/ 60, 2) as TIME_TAKEN
from
	meta_data m
...
where	bfpsyncstatusenum = 'SUCCESS'
	...
	and date(bb.create_date) = '2021-05-30'
