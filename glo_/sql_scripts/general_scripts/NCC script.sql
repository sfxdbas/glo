 create table ncc_record_07062021 as 
select * from ncc_record
;

truncate ncc_record ;

select * from ncc_record_07062021 nr ;
...
insert  into TEMP_NCC_RECORD (phone_number, kyc_date, unique_id, p, id, cat_status)
select 
...
commit;
 ...
 select /* parallel(50) */ hibernate_sequence.nextval, unique_id, phone_number, cat_status, id, sysdate as date_ ,0,kyc_date
from TEMP_NCC_RECORD_VALID_NEW;
