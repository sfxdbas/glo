...
-- *check data 
select hibernate_sequence.nextval pk, er.id er_id, device_id er_device_id, code er_kittag, dtr.pk dtr_id, requested_device_id dtr_device_id, kit_tag dtr_kittag, date(now())
