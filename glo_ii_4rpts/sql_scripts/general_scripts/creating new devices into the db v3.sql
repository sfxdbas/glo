...
select * from state;
--
--alter table new_kd_7 rename channel_partner_name to partner_name;
--alter table new_kd_7 rename trade_code to code;
--alter table new_kd_7 rename geopolitical_state to state;
--alter table new_kd_7 rename phone_numer to phone_number;
--alter table new_kd_7 rename partner_email to email;
...
from new_kd_7 ts left join state on
